...
class MenuPage {
    ...
    setupScrollAnimations() {
        const cuisineSections = document.querySelectorAll('.menu-cuisine-section');
        ...
        cuisineSections.forEach(section => observer.observe(section));
    }

    setupSmoothScrolling() {
        // Smooth scroll for menu options
